    	...
    	<div class="modal-dialog">    
        	<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Success!</strong> Your information has been successfully recorded.
        		</div>
      		</div>      
		</div>
	</div><!--/.Modal--> 
  	...
  	<div class="modal fade" id="update_Success" tabindex="-1" role="dialog" aria-labelledby="update_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Success!</strong> Your information has been successfully updated.
        		</div>
      		</div>
    	</div>
  	...
  	<div class="modal fade" id="delete_Success" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Success!</strong> Your information has been successfully deleted.
        		</div>
      		</div>
    	</div>
  	</div><!--/.Modal--> 
	...
	<div class="modal fade" id="classroom_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Classroom is already in the Database.
        		</div>
			</div>
		</div>
	</div><!--/.Modal-->
	...
	<div class="modal fade" id="grade_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Grade is already in the Database.
        		</div>
			</div>
		</div>
	</div><!--/.Modal--> 
	...
	<div class="modal fade" id="subject_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Subject is already in the Database.
        		</div>
			</div>
		</div>
	</div><!--/.Modal--> 
	...
	<div class="modal fade" id="exam_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Exam is already in the Database.
        		</div>
			</div>
		</div>
	</div><!--/.Modal--> 
  	...
  	<div class="modal fade" id="index_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Index Number already in the Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="email_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Email Address already in the Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="index_email_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Index Number and Email Address already in the  Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="exam_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Exam name already in the  Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="attendance_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> Your Attendance already in the Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="duplicate_Record2" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> At this time there is already a class, in that classroom. 
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="wrong_Index" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This Index Number haven't in the Database.
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->	